...
public Loan()
   {
		...
		ll= new JLabel("Loan Information");
...
hide();
 ...
 if(b2==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 Loan.dosave(t1.getText(),t2.getText(),t3.getText(),t4.getText(),ta1.getText(),t5.getText(),t6.getText(),t7.getText());
      }
if(b3==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 Loan.doupdate(t1.getText(),t2.getText(),t3.getText(),t4.getText(),ta1.getText(),t5.getText(),t6.getText(),t7.getText());
      }

if(b4==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 Loan.dodelete(t1.getText());
      }
...
try
	  ...
	  Statement st=con.createStatement();
         String sss="insert into Loan values("+s1+",'"+s2+"','"+s3+"',"+s4+","+s5+",'"+s6+"','"+s7+"','"+s8+"')";     
...
try
	  ...
	  Statement st=con.createStatement();
         String sss="update  Loan set  Bank_name= '"+s2+"',  Bank_add= '"+s3+"', Cust_id= "+s4+", amount = "+s5+", Duration = '"+s6+"', monthly_inst = '"+s7+"', EMI= '"+s8+"'  where Loan_no= "  + Integer.parseInt(s1);    
...
try
	  ...
	  Statement st=con.createStatement();
         String sss="delete from Loan where Loan_no= "  + Integer.parseInt(s1);    
  ...
  while(rs.next())
  {
	...
	if(rrr==true)
	{
                 JOptionPane.showMessageDialog(null,"Record is found","Search Query",JOptionPane.INFORMATION_MESSAGE);
                  String sss="Select * from Loan  where Loan_no = "+y;
	 JOptionPane.showMessageDialog(null,sss,"Search Query",JOptionPane.INFORMATION_MESSAGE);
	ResultSet rs1=st1.executeQuery("Select * from Loan  where Loan_no = "+y);
	  while(rs1.next())
 	 {
  ...
  while(rs.next())
  {
    ...
    if(y==1)  {break;}
	 ...
	 JOptionPane.showMessageDialog(null,"First Record is found","Search Query",JOptionPane.INFORMATION_MESSAGE);
                	ResultSet rs1=st1.executeQuery("select * from Loan  where Loan_no= "+id1);
	  while(rs1.next())
 	 {
   	  t1.setText(String.valueOf(rs1.getInt(1)));
        	 t2.setText(String.valueOf(rs1.getString(2)));
...
ResultSet rs=st.executeQuery("Select max(Loan_no) from Loan");
  while(rs.next())
  { 
     y=rs.getInt(1);   
   } 
   y++; 
        ...
        JOptionPane.showMessageDialog(null,"New Record is added with Loan_no =" +y,"Search Query",JOptionPane.INFORMATION_MESSAGE);
...
public static  Loan s1;
public static void main(String s[])
	{
		 s1 =new Loan();
s1.setTitle("Vehicle Showroom Sales System ........ Loan Details");
		s1.show();
	}
}