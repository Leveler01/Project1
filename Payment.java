...
public Payment()
   {
		...
		ll= new JLabel("Payment Details");
		ll.setBounds(90,3,600,75);
...
public void actionPerformed(ActionEvent ae)
{
 ...
 if(b2==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 Payment.dosave(t1.getText(),t2.getText(),t3.getText(),t4.getText(),ta1.getText(),t5.getText(),t6.getText());
      }

if(b3==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 Payment.doupdate(t1.getText(),t2.getText(),t3.getText(),t4.getText(),ta1.getText(),t5.getText(),t6.getText());
      }
...
ResultSet rs=st.executeQuery("Select max(pay_id) from Payment");
  ...
  { 
   ...
   y++; 
        ...
        JOptionPane.showMessageDialog(null,"New Record is added with pay_id =" +y,"Search Query",JOptionPane.INFORMATION_MESSAGE);
...
try
	  ...
	  Statement st=con.createStatement();
         String sss="insert into Payment values("+s1+","+s2+",'"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"')";  
...
try
	  ...
	  Statement st=con.createStatement();
         String sss="update  Payment set  bill_no= "+s2+",  paydate= '"+s3+"', paymode= '"+s4+"', amount = '"+s5+"', bankname= '"+s6+"',chequeno = '"+s7+"'  where pay_id= "  + Integer.parseInt(s1);    
...
try
	  ...
	  Statement st=con.createStatement();
         String sss="delete from  Payment where pay_id= "  + Integer.parseInt(s1);    
  ...
  while(rs.next())
  {
	...
	if(rrr==true)
	{
                 JOptionPane.showMessageDialog(null,"Record is found","Search Query",JOptionPane.INFORMATION_MESSAGE);
                  String sss="select * from Payment  where pay_id = "+y;
	 JOptionPane.showMessageDialog(null,sss,"Search Query",JOptionPane.INFORMATION_MESSAGE);
	ResultSet rs1=st1.executeQuery("select * from Payment  where pay_id = "+y);
	  while(rs1.next())
 	 {
  ...
  while(rs.next())
  {
    ...
    if(y==1)  {break;}
	 ...
	 JOptionPane.showMessageDialog(null,"First Record is found","Search Query",JOptionPane.INFORMATION_MESSAGE);
                	ResultSet rs1=st1.executeQuery("select * from Payment  where pay_id = "+id1);
	  while(rs1.next())
 	 {
   	  t1.setText(String.valueOf(rs1.getInt(1)));
        	 t2.setText(String.valueOf(rs1.getInt(2)));
...
public static  Payment s1;	
public static void main(String s[])
	{
		 s1 =new Payment();
s1.setTitle("Vehicle Showroom Sales System ........  Payment details");
		s1.show();
	}
}