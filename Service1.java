...
public class Service1 extends JFrame implements ActionListener , KeyListener
{
   JLabel ll,l1,l2,l3,l4,l5,l6,bic1,bic2;
...
public Service1()
   {
		...
		ll= new JLabel("Service Details");
		ll.setBounds(110,10,600,75);
...
if(b2==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 Service1.dosave(t1.getText(),t2.getText(),t3.getText(),t4.getText(),t5.getText(),ta1.getText());
      }

if(b3==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 Service1.doupdate(t1.getText(),t2.getText(),t3.getText(),t4.getText(),t5.getText(),ta1.getText());
      }

 if(b4==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 Service1.dodelete(t1.getText());
      }
...
ResultSet rs=st.executeQuery("Select max(ser_id) from Service");
  while(rs.next())
  { 
     y=rs.getInt(1);   
   } 
   y++; 
        ...
        JOptionPane.showMessageDialog(null,"New Record is added with ser_id =" +y,"Search Query",JOptionPane.INFORMATION_MESSAGE);
...
try
	  ...
	  Statement st=con.createStatement();
         String sss="insert into Service values("+s1+","+s2+","+s3+",'"+s4+"',"+s5+",'"+s6+"')";     
...
public static void doupdate(String s1,String s2,String s3,String s4,String s5,String s6)
{
try
        {
	  ...
	  Statement st=con.createStatement();
         String sss="update  service set  spid= "+s2+",  comp_id= "+s3+", serdate= '"+s4+"', charges = "+s5+", description= '"+s6+"' where ser_id= "  + Integer.parseInt(s1);    
...
try
	  ...
	  Statement st=con.createStatement();
         String sss="delete from  Service   where ser_id= "  + Integer.parseInt(s1);    
  ...
  while(rs.next())
  {
	...
	if(rrr==true)
	{
                 JOptionPane.showMessageDialog(null,"Record is found","Search Query",JOptionPane.INFORMATION_MESSAGE);
                  String sss="select * from service  where ser_id = "+y;
	 JOptionPane.showMessageDialog(null,sss,"Search Query",JOptionPane.INFORMATION_MESSAGE);
	ResultSet rs1=st1.executeQuery("select * from service  where ser_id = "+y);
	  while(rs1.next())
 	 {
   	  t1.setText(String.valueOf(rs1.getInt(1)));
        	 t2.setText(String.valueOf(rs1.getInt(2)));
         	t3.setText(String.valueOf(rs1.getInt(3)));
         	t4.setText(String.valueOf(rs1.getDate(4)));
        	t5.setText(String.valueOf(rs1.getInt(5)));
		ta1.setText(String.valueOf(rs1.getString(6)));
  ...
  while(rs.next())
  {
    ...
    if(y==1)  {break;}
	 ...
	 JOptionPane.showMessageDialog(null,"First Record is found","Search Query",JOptionPane.INFORMATION_MESSAGE);
                	ResultSet rs1=st1.executeQuery("select * from Service  where ser_id = "+id1);
	  while(rs1.next())
 	 {
   	  t1.setText(String.valueOf(rs1.getInt(1)));
        	 t2.setText(String.valueOf(rs1.getInt(2)));
        	 ...
        	 ta1.setText(String.valueOf(rs1.getInt(5)));
...
public static  Service1 s1;
public static void main(String s[])
	{
		 s1 =new Service1();
s1.setTitle("Vehicle Showroom Sales System ........ Service Details");
		s1.show();
	}
}//class ends