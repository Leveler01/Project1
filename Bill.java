/*Form is done but little error in first and last buttons*/
...
public Bill()
   ...
   l7=new JLabel("Total");
      ...
      b1=new JButton("Add");
		...
		t1.addKeyListener(this);  //billno
		t2.addKeyListener(this);  //bookid
		t3.addKeyListener(this);   //vid
		ta1.addKeyListener(this);  //amt
		t5.addKeyListener(this);    //tax
		t6.addKeyListener(this);    //total
...
if(b2==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 boolean r2=Bill.dosave(t1.getText(),t2.getText(),t3.getText(),t4.getText(),ta1.getText(),t5.getText(),t6.getText());
         if(r2==true)
...
JOptionPane.showMessageDialog(null,"Record is not saved","Save Messege",JOptionPane.INFORMATION_MESSAGE);
 ...
 if(b3==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 Bill.doupdate(t1.getText(),t2.getText(),t3.getText(),t4.getText(),ta1.getText(),t5.getText(),t6.getText());
      }

 if(b4==ae.getSource())
     {
         System.out.println("\n\tEvent occurs\n");
	 Bill.dodelete(t1.getText());
      }
...
public static boolean dosave(String s1,String s2,String s3,String s4,String s5,String s6,String s7)
{
boolean b=false;
try
        {
...
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver"); 
          ...
          String sss="insert into Bill values("+s1+","+s2+","+s3+",'"+s4+"',"+s5+","+s6+","+s7+")";     
...
try
	  ...
	  Statement st=con.createStatement();    
           String sss="update  Bill set  ord_id= "+s2+",  vid= "+s3+", billdate= '"+s4+"', bill_amt = "+s5+", vat= "+s6+", total = "+s7+"  where bill_no= "  + Integer.parseInt(s1);    
...
try
	  ...
	  Statement st=con.createStatement();
         String sss="delete from  Bill   where bill_no= "  + Integer.parseInt(s1);    
  ...
  while(rs.next())
  {
	...
	if(rrr==true)
	{
                 JOptionPane.showMessageDialog(null,"Record is found","Search Query",JOptionPane.INFORMATION_MESSAGE);
                  String sss="select * from Bill where bill_no = "+y;
	 JOptionPane.showMessageDialog(null,sss,"Search Query",JOptionPane.INFORMATION_MESSAGE);
	ResultSet rs1=st1.executeQuery("select * from Bill  where bill_no = "+y);
	  while(rs1.next())
 	 {
        	...
        	ta1.setText(String.valueOf(rs1.getInt(5)));
         	...
         	t6.setText(String.valueOf(rs1.getInt(7)));
  ...
  while(rs.next())
  {
    ...
    if(y==1)  {break;}
	 ...
	 JOptionPane.showMessageDialog(null,"First Record is found","Search Query",JOptionPane.INFORMATION_MESSAGE);
                	ResultSet rs1=st1.executeQuery("select * from Bill where bill_no = "+id1);
	  while(rs1.next())
 	 {
                t1.setText(String.valueOf(rs1.getInt(1)));
        	t2.setText(String.valueOf(rs1.getInt(2)));
...
ResultSet rs=st.executeQuery("Select max(bill_no) from Bill");
  ...
  { 
   ...
   y++; 
        ...
        JOptionPane.showMessageDialog(null,"New Record is added with bill no =" +y,"Search Query",JOptionPane.INFORMATION_MESSAGE);
